...
Read-only enforcement for any file in this project carrying a YAML file header (see `file-format.md`). Based on `documents/method/BOOT.md`. Applies project-wide.
