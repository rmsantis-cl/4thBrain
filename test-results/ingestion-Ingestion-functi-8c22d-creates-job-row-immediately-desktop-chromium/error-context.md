...
- Name: ingestion.spec.js >> Ingestion functionality >> file ingestion: file upload creates job row immediately
- Location: tests\ui\ingestion.spec.js:40:3
...
Call log:
  - waiting for locator('#file-submit')
...
- generic [ref=e1]:
  ...
  - main [ref=e36]:
    - generic [ref=e37]:
      - heading "Add file" [level=1] [ref=e38]
      - paragraph [ref=e39]: Drop a file or browse.
      - generic [ref=e40]:
        - generic [ref=e41] [cursor=pointer]: Drag a file here, or click to browse
        - textbox "Tags (comma-separated)" [active] [ref=e42]: e2e-file-1788052636680-a4qeua
        - generic [ref=e43]: staged "sample.txt" (185 bytes) to C:\Users\rsant\desar\github\4thBrain\tests\ui\.tmp\raw\inbox\4fb3da90-b08b-43f7-b7fb-fb64f0e1cfa8.txt (jobId 1)
```
