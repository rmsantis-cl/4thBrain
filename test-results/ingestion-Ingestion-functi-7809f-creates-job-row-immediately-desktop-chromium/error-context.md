...
- Name: ingestion.spec.js >> Ingestion functionality >> URL ingestion: URL submission creates job row immediately
- Location: tests\ui\ingestion.spec.js:74:3
...
Call log:
  - waiting for locator('#url-submit')
...
- generic [ref=e1]:
  ...
  - main [ref=e36]:
    - generic [ref=e37]:
      - heading "Add url" [level=1] [ref=e38]
      - paragraph [ref=e39]: Submit a link to be clipped.
      - generic [ref=e41]:
        - textbox "https://…" [ref=e42]: https://example.com
        - textbox "Tags (comma-separated)" [active] [ref=e43]: e2e-url-1788052668150-946dkj
