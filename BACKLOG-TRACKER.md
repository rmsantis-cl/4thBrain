...
| ID        | Title                                        | Note                                                                                                  |
| --------- | -------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [[P1.11]] | Coordinator Entry Point & Message Addressing | Unblocked by [[P1.9]]. Stage 1 of [[UI-ENTRY-POINTS-PLAN]]                                                   |
...
| [[P1.17]] | Spike: A Unified Composer                    | Stage 2 of [[UI-ENTRY-POINTS-PLAN]]; runs alongside [[P1.11]], lands before [[P1.13]]                     |
...
| ID | Title | Blocked by |
|----|-------|------------|
| [[P1.13]] | Text and URL Ingestion Endpoints | [[P1.11]], [[P1.17]] — stage 3 of [[UI-ENTRY-POINTS-PLAN]] |
...
Plans under `documents/`: [[UI-ENTRY-POINTS-PLAN]] covers P1.11, P1.17 and P1.13 together, and
[[P1.9-FIX-PLAN]] and [[P3.5-UPGRADE-PLAN]] cover a story each. Design artifacts they depend on are
