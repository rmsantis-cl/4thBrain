...
changed. The total was right; READY had been understated by two and NOT-READY overstated by three,
which is drift accumulated over several passes rather than any story moving. Counting the rows takes
a minute and is worth doing before trusting these numbers.
...
Full details: [[BUG-001]], [[BUG-002]], [[BUG-003]], [[BUG-004]], [[BUG-005]] — one file per bug under `documents/bug/`.
...
Each was written on a branch or in a pass where appending to one shared file would have conflicted.
