...
36 stories: 1 WIP, 8 READY, 8 NOT-READY, 19 COMPLETED.
4 bugs: 2 READY, 2 COMPLETED.
...
| [[P2.5]]  | Indexer Real Logic                      | **Part A implemented and verified, not merged** — on its agent branch, held back at the user's direction. Part B stays blocked on **ADR30** |
...
Full details: [[BUG-001]], [[BUG-002]], [[BUG-003]], [[BUG-004]] — one file per bug under `documents/bug/`.
