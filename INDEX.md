...
| File Name | History |
|-----------|----------|
| CLAUDE.md | [2026-09-03] Project overview, three-phase delivery plan (Skeleton → Real Logic → Testing), repository structure, design decisions inherited from v03<br>[2026-09-07] Repository structure corrected — `chat.html`, `styles.css` and `client.js` were listed but have never existed, and `templates/` was absent. Added a design principle covering how to add a UI page under ADR25, including the `${...}` template-literal trap |
