...
| documents/design/ADRS.md | [2026-09-03] Architecture Decision Records (reference to v03: ADR14, ADR17, ADR24)<br>[2026-09-07] File actually created — it had been indexed and cited since 2026-09-03 but never written. Records that ADR1–ADR24 stay inherited from v03, and adds ADR25: Thymeleaf is the view layer, served pages live in `templates/`, `static/` holds only linked assets. Written up with the counterargument (it buys nothing today) and the `${...}` JavaScript-vs-Thymeleaf trap |
...
| documents/story/P1.14.md | [2026-09-07] View layer and template engine — add Thymeleaf, move index.html into templates/, replace the System.out stubs in both controllers; closes BUG-001, design in ADR25, verification waits on P1.9 |
